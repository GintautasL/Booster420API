...
class UserController {
  ...
  /**
   * Gets user boosterprograms
   * GET users/:id/boosterprogramas
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
   * @param {View} ctx.view
   */
  async getBoosterPrograms({ request: { user } }) {
    return user.boosterprograms().fetch();
  }
  ...
  /**
   * Gets user boosterprograms
   * GET user/boosterprograms
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
   */
  async getMyBoosterPrograms({ auth }) {
    const user = auth.user;
    return user.boosterprograms().fetch();
  }
